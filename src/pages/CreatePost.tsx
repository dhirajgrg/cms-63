  ...
  return (
    <div>
      ...
      <RHFInput
        ...
        type="text"
        placeholder="title"
        className=" w-fit outline outline-zinc-200 px-2 py-1 rounded-lg text-sm text-neutral font-inter focus:outline-violet-400"
      />
      <RHFInput
        control={control}
        name="description"
      ...
      <Select
        ...
        name="category"
        options={options}
        className="border border-violet-400 rounded-full pl-4 py-2 text-xs font-inter  "
      />
      <div>
        <LabelForm
          htmlFor="image"
